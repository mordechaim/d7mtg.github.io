...
e = function () {
    ...
    var o = (e.navigator || {}).userAgent,
        ...
        u = n,
        i = !!l.document,
        c = !!u.documentElement && !!u.head && "function" == typeof u.addEventListener && "function" == typeof u.createElement,
        s = (~r.indexOf("MSIE") || r.indexOf("Trident/"), []),
        f = !1;

    function d(e) {
        c && (f ? setTimeout(e, 0) : s.push(e))
    }
    c && ((f = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(u.readyState)) || u.addEventListener("DOMContentLoaded", function e() {
        u.removeEventListener("DOMContentLoaded", e), f = 1, s.map(function (e) {
            return e()
        })
    }));
    ...
    function p(e) {
        if (null !== e && "object" === t(e)) return e.src ? h(e.src) : e.href ? h(e.href) : e.innerText && "" !== e.innerText ? h(e.innerText) : void 0
    }
    var v = "fa-kits-diag",
        y = "fa-kits-node-under-test",
        w = "data-md5",
        b = "data-fa-detection-ignore",
        A = "data-fa-detection-timeout",
        x = "data-fa-detection-results-collection-max-wait",
        T = function (e) {
    ...
    function C() {
        ...
        var e = function (t) {
                for (var c = Array.from(u.scripts).filter(function (e) {
                        ...
                        }.toString(), ")('").concat(y, "', '").concat(o, "', '").concat(i, "');"), t.onload = function () {
                            t.contentWindow.addEventListener("error", T, !0), t.contentDocument.head.appendChild(r), t.contentDocument.head.appendChild(n)
                        }, d(function () {
            ...
            o = function () {
                var e = Array.from(u.getElementsByTagName("link")).filter(function (e) {
                        return !e.hasAttribute(b)
                    }),
                    t = Array.from(u.getElementsByTagName("style")).filter(function (e) {
                        return !(e.hasAttribute(b) || l.FontAwesomeConfig && e.innerText.match(new RegExp("svg:not\\(:root\\)\\.".concat(l.FontAwesomeConfig.replacementClass))))
                    });
                ...
                function n(e, t) {
                    ...
                    i.innerText = "(".concat(function (n, o, r, i) {
                        parent.FontAwesomeDetection.__pollUntil({
                            fn: function () {
                                ...
                                return !(!t.match(/FontAwesome/) && !t.match(/Font Awesome 6/))
                            }
                        }).then(function () {
                            var e = document.getElementById(n);
                            parent.postMessage({
                    ...
                    }.toString(), ")('").concat(y, "', '").concat(o || "foo", "', '").concat(t, "', '").concat(c, "');"), n.onload = function () {
                        n.contentWindow.addEventListener("error", T, !0), n.contentDocument.head.appendChild(i), n.contentDocument.head.appendChild(e), n.contentDocument.body.appendChild(r)
                    }, d(function () {
                ...
                for (var o = {}, r = 0; r < e.length; r++) {
                    ...
                    i.setAttribute("id", y), i.setAttribute("href", e[r].href), i.setAttribute("rel", e[r].rel);
                    var c = p(e[r]);
        ...
        console.group("Font Awesome Detector"), 0 === i ? (console.info("%cAll Good!", "color: green; font-size: large"), console.info("We didn't find anything that needs testing for conflicts. Ergo, no conflicts.")) : (console.info("Testing ".concat(i, " possible conflicts.")), console.info("We'll wait about ".concat(Math.round(l.FontAwesomeDetection.timeout / 10) / 100, " seconds while testing these and\n") + "then up to another ".concat(Math.round(l.FontAwesomeDetection.resultsCollectionMaxWait / 10) / 100, " to allow the browser time\n") + "to accumulate the results. But we'll probably be outta here way before then.\n\n"), console.info("You can adjust those durations by assigning values to these attributes on the <script> element that loads this detection:"), console.info("\t%c".concat(A, "%c: milliseconds to wait for each test before deciding whether it's a conflict."), "font-weight: bold;", "font-size: normal;"), console.info("\t%c".concat(x, "%c: milliseconds to wait for the browser to accumulate test results before giving up."), "font-weight: bold;", "font-size: normal;"), E({
            ...
            "timeout" === e ? console.info("TIME OUT! We waited until we got tired. Here's what we found:") : (console.info("Whoops! We hit an error:", e), console.info("Here's what we'd found up until that error:")), D({
                nodesTested: n,
                nodesFound: r
            }), t({
                nodesTested: n,
    ...
    var F = l.FontAwesomeDetection || {},
        O = a({}, {
            ...
            resultsCollectionMaxWait: +(u.currentScript.getAttribute(x) || "5000")
        }, F, {
            __pollUntil: E,
            md5ForNode: p,
            detectionDone: !1,
    ...
    ! function (e) {
        ...
        i && c && C(window.FontAwesomeDetection.report)
    })
